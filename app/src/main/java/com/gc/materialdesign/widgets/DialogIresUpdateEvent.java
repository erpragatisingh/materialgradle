...
public class DialogIresUpdateEvent extends android.app.Dialog{
	...
	public DialogIresUpdateEvent(Context context,String title, String message) {
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.dialog_update_event);
