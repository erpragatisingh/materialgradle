...
public class DialogIresDeleteWishItem extends android.app.Dialog{
	...
	public DialogIresDeleteWishItem(Context context,String title, String message) {
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.dialog_del_w_item);
