...
public class DialogIresBlockWishItem extends android.app.Dialog{
	...
	public DialogIresBlockWishItem(Context context,String title, String message) {
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.dialog_block_wish_item);
