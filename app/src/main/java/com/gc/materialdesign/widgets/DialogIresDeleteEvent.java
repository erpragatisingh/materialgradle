...
public class DialogIresDeleteEvent extends android.app.Dialog{
	...
	public DialogIresDeleteEvent(Context context,String title, String message) {
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.dialog_del_event);
